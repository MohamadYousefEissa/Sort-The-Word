<template>
  <label class="theme-btn-cont">
    <input type="checkbox" class="theme-btn" name="theme-btn" @change="changeTheme" />
...
/* ------ On check event ------ */
.theme-btn-cont input:checked ~ .moon {
  display: block;
}

.theme-btn-cont input:checked ~ .sun {
  display: none;
}

/* ------ Hide the default checkbox ------ */
.theme-btn-cont input {
  position: absolute;
  opacity: 0;
  cursor: pointer;
  height: 0;
